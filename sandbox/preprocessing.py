...
if __name__ == "__main__":
    ...
    sys.path.extend(
        ['/media/maxim/5d25e004-74c4-4174-8cd3-d5dce3ff6981/maxim/anaconda/envs/pushkin_card_recommender_system',
         '/media/maxim/5d25e004-74c4-4174-8cd3-d5dce3ff6981/maxim/anaconda/envs/pushkin_card_recommender_system/data',
         '/media/maxim/5d25e004-74c4-4174-8cd3-d5dce3ff6981/maxim/anaconda/envs/pushkin_card_recommender_system/dataset'],
    )

    UNIQ_FILE_PATH = '../data/uniq.txt'
