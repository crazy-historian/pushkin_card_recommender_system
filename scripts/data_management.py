...
REGION_FILE_PATH = cfg.REGION_FILE_PATH
REGION_NUMS_FILE_PATH = cfg.REGION_NUMS_FILE_PATH
USERS_FILE_PATH = cfg.USERS_FILE_PATH
CLICK_FILE_PATH = cfg.CLICK_FILE_PATH
EXPANDED_CLICK_FILE_PATH = cfg.CLICKS_ADD_PATH

ALL_EVENTS_FILE_PATH = cfg.ALL_EVENTS_FILE_PATH
FUTURE_EVENTS = cfg.EVENTS_FILE_PATH
