...
def get_event_dataframe(events_data_path: str,
    ...
    events_all_df['organization_id'].fillna(1000000000)
...
def get_merged_click_event_dataframe(events_dataframe: pd.DataFrame,
    ...
    clicks_add = pd.merge(clicks_add, organizations_dataframe[['organization_id', 'org_category']],
...
def save_to_csv(dataframe: pd.DataFrame, path: str):
    dataframe.to_csv(path + 'cliks_add.csv', sep=';', index=False)
